...
To see what other parameters you can pass to runClio, see the docs for [OpenClioConfig](project-wiki/opencliotypes.md#opencliotypes.OpenClioConfig). Any of these fields can be passed into runClio and they will be [used](https://github.com/Phylliida/OpenClio/blob/main/openclio/openclio.py#L118)