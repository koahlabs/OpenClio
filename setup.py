...
setuptools.setup(
    ...
    python_requires = ">=3.6",
    install_requires = ["tqdm", "umap-learn[plot]", "numba", "cryptography", "dataclasses", "vllm","pandas", "sentence_transformers", "numpy", "scikit-learn", "scipy", "torch", "cloudpickle", "setuptools", "pyarrow", "faiss-cpu"]
)
